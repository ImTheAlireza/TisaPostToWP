...
| 4.5 موجودی، 4.6 تصویر/`menu_order`/`sale_price` واریژن، 4.8 صف خروجی | ⏳ | آیتم‌های بعدی همین فاز (بخش سوم: split 4.1 و نیمی از 4.4 — جدول پایین) |
...
| 4.5 موجودی، 4.6 تصویر/`menu_order`/`sale_price`، 4.8 صف خروجی | ⏳ | همان سه مورد قبلی؛ dry-run هم هنوز فروشگاه سالم را شبیه‌سازی می‌کند (۵۰۰/هانگ نه) |
