...
پیاده‌سازی §۴.۲: ماشین‌حالت، ویرایش فیلد‌محور ✅ (بخش اول)، دکمهٔ پایان، diff، کارت نتیجه، «محصول بعدی»،
...
| کارت نتیجه، «📦 محصول بعدی»، `🧾 آخرین محصولات`، `🔍 تست پارسر` | ⏳ ۳b | «🧾 آخرین محصولات» و «🔍 تست پارسر» در `bot/modules/devtools.py` هستند؛ یکپارچه‌سازی با کارت نتیجهٔ جدید در همین بخش |
